        ...
        static {
                ...
                edgesHashMap.put(new Vector2i(-9, 0),
                                new int[] { Node.getIntegerIndex(PlayerDirection.RIGHT, true, 9),
                                                Node.getIntegerIndex(PlayerDirection.RIGHT, false, 9),
                                                Node.getIntegerIndex(PlayerDirection.RIGHT, false, 10) });
                edgesHashMap.put(new Vector2i(-10, 0),
                ...
                edgesHashMap.put(new Vector2i(0, 1),
                                new int[] { Node.getIntegerIndex(PlayerDirection.UP, true, 1),
                                                Node.getIntegerIndex(PlayerDirection.UP, true, 2),
                                                Node.getIntegerIndex(PlayerDirection.UP, true, 3),
                                                Node.getIntegerIndex(PlayerDirection.UP, true, 4),
                                                Node.getIntegerIndex(PlayerDirection.UP, true, 5),
                                                Node.getIntegerIndex(PlayerDirection.UP, true, 6),
                                                Node.getIntegerIndex(PlayerDirection.UP, true, 7),
                                                Node.getIntegerIndex(PlayerDirection.UP, true, 8),
                                                Node.getIntegerIndex(PlayerDirection.UP, true, 9),
                                                Node.getIntegerIndex(PlayerDirection.UP, true, 10),
                                                Node.getIntegerIndex(PlayerDirection.UP, false, 1),
                                                Node.getIntegerIndex(PlayerDirection.UP, false, 2),
                                                Node.getIntegerIndex(PlayerDirection.UP, false, 3),
                                                Node.getIntegerIndex(PlayerDirection.UP, false, 4),
                                                Node.getIntegerIndex(PlayerDirection.UP, false, 5),
                                                Node.getIntegerIndex(PlayerDirection.UP, false, 6),
                                                Node.getIntegerIndex(PlayerDirection.UP, false, 7),
                                                Node.getIntegerIndex(PlayerDirection.UP, false, 8),
                                                Node.getIntegerIndex(PlayerDirection.UP, false, 9),
                                                Node.getIntegerIndex(PlayerDirection.UP, false, 10) });
                edgesHashMap.put(new Vector2i(0, 2),
                                new int[] { Node.getIntegerIndex(PlayerDirection.UP, true, 2),
                                                Node.getIntegerIndex(PlayerDirection.UP, false, 2),
                                                Node.getIntegerIndex(PlayerDirection.UP, false, 3),
                                                Node.getIntegerIndex(PlayerDirection.UP, false, 4),
                                                Node.getIntegerIndex(PlayerDirection.UP, false, 5),
                                                ...
                                                Node.getIntegerIndex(PlayerDirection.UP, false, 10) });
                edgesHashMap.put(new Vector2i(0, 3),
                                new int[] { Node.getIntegerIndex(PlayerDirection.UP, true, 3),
                                                Node.getIntegerIndex(PlayerDirection.UP, false, 3),
                                                Node.getIntegerIndex(PlayerDirection.UP, false, 4),
                                                Node.getIntegerIndex(PlayerDirection.UP, false, 5),
                                                Node.getIntegerIndex(PlayerDirection.UP, false, 6),
                                                ...
                                                Node.getIntegerIndex(PlayerDirection.UP, false, 10) });
                edgesHashMap.put(new Vector2i(0, 4),
                                new int[] { Node.getIntegerIndex(PlayerDirection.UP, true, 4),
                                                Node.getIntegerIndex(PlayerDirection.UP, false, 4),
                                                Node.getIntegerIndex(PlayerDirection.UP, false, 5),
                                                Node.getIntegerIndex(PlayerDirection.UP, false, 6),
                                                Node.getIntegerIndex(PlayerDirection.UP, false, 7),
                                                ...
                                                Node.getIntegerIndex(PlayerDirection.UP, false, 10) });
                edgesHashMap.put(new Vector2i(0, 5),
                                new int[] { Node.getIntegerIndex(PlayerDirection.UP, true, 5),
                                                Node.getIntegerIndex(PlayerDirection.UP, false, 5),
                                                Node.getIntegerIndex(PlayerDirection.UP, false, 6),
                                                Node.getIntegerIndex(PlayerDirection.UP, false, 7),
                                                Node.getIntegerIndex(PlayerDirection.UP, false, 8),
                                                ...
                                                Node.getIntegerIndex(PlayerDirection.UP, false, 10) });
                edgesHashMap.put(new Vector2i(0, 6),
                                new int[] { Node.getIntegerIndex(PlayerDirection.UP, true, 6),
                                                Node.getIntegerIndex(PlayerDirection.UP, false, 6),
                                                Node.getIntegerIndex(PlayerDirection.UP, false, 7),
                                                Node.getIntegerIndex(PlayerDirection.UP, false, 8),
                                                Node.getIntegerIndex(PlayerDirection.UP, false, 9),
                                                Node.getIntegerIndex(PlayerDirection.UP, false, 10) });
                edgesHashMap.put(new Vector2i(0, 7),
                                new int[] { Node.getIntegerIndex(PlayerDirection.UP, true, 7),
                                                Node.getIntegerIndex(PlayerDirection.UP, false, 7),
                                                Node.getIntegerIndex(PlayerDirection.UP, false, 8),
                                                Node.getIntegerIndex(PlayerDirection.UP, false, 9),
                                                Node.getIntegerIndex(PlayerDirection.UP, false, 10) });
                edgesHashMap.put(new Vector2i(0, 8),
                                new int[] { Node.getIntegerIndex(PlayerDirection.UP, true, 8),
                                                Node.getIntegerIndex(PlayerDirection.UP, false, 8),
                                                Node.getIntegerIndex(PlayerDirection.UP, false, 9),
                                                Node.getIntegerIndex(PlayerDirection.UP, false, 10) });
                edgesHashMap.put(new Vector2i(0, 9),

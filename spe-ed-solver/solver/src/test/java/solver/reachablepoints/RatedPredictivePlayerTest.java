...
public class RatedPredictivePlayerTest {
	...
	public void testSuccessCalculation() {
		...
		assertEquals(0.159, nextPlayer.getSuccessRating(), 0.01);
	}
	...
	public void testChildSuccessCalculation() {
		...
		assertEquals(0.0527, nextPlayer1.getSuccessRating(), 0.001);
	}
	...
	public void testCutOffCalculation() {
		...
		assertEquals(0.0477, nextPlayer.getCutOffRating(), 0.001);
	}
